...
class ArticleBean {
  ...
  ArticleBean(this.data, this.starred, this.date);
  ...
  String toGson(){
    return "{'starred':'${this.starred}','date':'${this.date}','data':"
        "'{'author':'${this.data.author}','title':'${this.data.title}','digest':'${this.data.digest}'}'}";
  }
...
class DataBean{
  ...
  DataBean(this.author, this.title, this.digest, this.content, this.wc,
      this.date);
